<div id="mailstatus" class="fa fa-check-circle fa-lg">&nbsp;&nbsp;Mailet skickades utan problem</div>
...
<!-- 
<label>Ort:</label>
<input type="text" name="ort" class="contactemail" placeholder="Ort"><br />
 -->
...
<a class="blackbutton contactsend" onclick="sendMessage(this);"><i class="fa fa-envelope"></i>&nbsp;&nbsp;Skicka f&ouml;rfr&aring;gan</a>
